...
def main(argv=None, custom_target=None, custom_val=None,shadow_list=None):
    ...
    MODE='mix'
    SEED = int(52)
    configurable_path = r"E:\machang\code\FedMIA-main\FedMIA-main\saved_mia_models\cremad_K10_N1100_AVClassifer_defnone_iid$0_$1.0_$sgd_local3_s42_mod$multimodal_random"
...
if __name__ == "__main__":
    ...
    COLLUDING_USERS = [0,1,2,3,4]

    # 2. 测试集构造用户 (Test Run)
    # 单独指定测试集的目标和验证集
    TEST_RUN = {'target': 9, 'val': [5,6,7,8]}
    # ================= 自动化执行逻辑 =================
